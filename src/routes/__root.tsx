...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: 'og:image:alt', content: '서울 생활 지도 — 쇼핑몰·공공화장실·약국 위치 지도' },
      {
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          '@type': 'WebSite',
          name: '서울 생활 지도',
          alternateName: '서울 생활 지도 | 쇼핑몰 · 공공화장실 · 약국',
          ...
          potentialAction: {
            ...
            target: {
              '@type': 'EntryPoint',
              urlTemplate: 'https://map.taskory.work/mall?q={search_term_string}',
            },
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: '서울 생활 지도',
          url: 'https://map.taskory.work',
          logo: 'https://map.taskory.work/logo192.png',
          description: '서울 쇼핑몰 흡연구역, 공공화장실, 약국 위치를 지도에서 한눈에 확인하세요.',
        }),
      },
    ],
