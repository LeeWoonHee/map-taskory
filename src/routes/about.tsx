...
export const Route = createFileRoute('/about')({
  head: () => ({
    meta: [
      ...
      { property: 'og:image:alt', content: '서울 생활 지도 — 쇼핑몰·공공화장실·약국 위치 지도 서비스 소개' },
      { property: 'og:locale', content: 'ko_KR' },
      { property: 'og:locale:alternate', content: 'en_US' },
      { property: 'og:site_name', content: '서울 생활 지도' },
      { property: 'kakao:title', content: '서울 생활 지도 소개 | 쇼핑몰 · 공공화장실 · 약국' },
      { name: 'theme-color', content: '#FFFFFF' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: '서울 생활 지도 소개 | 쇼핑몰 · 공공화장실 · 약국' },
      { name: 'twitter:description', content: '서울의 쇼핑몰 흡연구역, 공공화장실, 약국 위치를 지도에서 한눈에 확인하세요.' },
      { name: 'twitter:image', content: 'https://map.taskory.work/og-image.png' },
      { name: 'twitter:image:alt', content: '서울 생활 지도 서비스 소개' },
      { name: 'robots', content: 'index, follow' },
    ],
    links: [
      { rel: 'canonical', href: 'https://map.taskory.work/about' },
    ],
    scripts: [
      {
